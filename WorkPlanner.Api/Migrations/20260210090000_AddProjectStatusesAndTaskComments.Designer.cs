...
namespace WorkPlanner.Api.Migrations
{
    ...
    [Migration("20260210090000_AddProjectStatusesAndTaskComments")]
    partial class AddProjectStatusesAndTaskComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkPlanner.Api.Models.Project", b =>
                {
                    ...
                    b.Property<string>("EnabledStatuses")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("TEXT")
                        .HasDefaultValue("Todo,InProgress,Done");
            ...
            modelBuilder.Entity("WorkPlanner.Api.Models.TaskComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WorkPlanner.Api.Models.TaskComment", b =>
                {
                    b.HasOne("WorkPlanner.Api.Models.ApplicationUser", "Author")
                        .WithMany()
